          ...
          <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
              {techStack[currentIndex]?.stack?.map((item, index) => (
                ...
                >
                  <div className="bg-white rounded-xl p-4 shadow-sm hover:shadow-lg group-hover:scale-105 border border-gray-200">
                    <img
                      src={item}
                      alt="tech stack"
                      className="w-full h-16 object-contain group-hover:scale-110"
                    />
                  </div>
                </div>
              ))}
