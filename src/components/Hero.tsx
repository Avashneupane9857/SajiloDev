...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden" style={{ zIndex: 1 }}>
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full py-20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {/* <button
                className="btn btn-outline text-lg px-8 py-4 bg-white/5 border-2 border-white/50 text-white hover:bg-white hover:text-black"
          ...
          <div className="relative">
            ...
            >
                  ...
                  >
                    <div className="relative overflow-hidden rounded-2xl shadow-2xl w-full h-48 border border-white/10">
                      <img
                        ...
                        alt={work?.title}
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 pointer-events-none">
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gray-400/20 rounded-full blur-xl pointer-events-none" />
            </div>
